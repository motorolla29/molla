      ...
      {loading ? (
        ...
        <div className="max-w-xs sm:max-w-sm mx-auto mt-8">
          <div className="bg-red-50/50 backdrop-blur-sm border border-red-200 rounded-2xl p-6 shadow-xl text-center">
            <div className="mb-2">
              <svg
                className="w-9 h-9 sm:w-10 sm:h-10 mx-auto text-red-500"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            <h3 className="text-sm sm:text-base font-semibold text-red-500 mb-2">
              Ошибка загрузки
            </h3>
          ...
          {reviews.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-500">
                Здесь будут отображаться ваши отзывы о других пользователях
              </p>
            </div>
          ) : (
