                  ...
                  {isLoggedIn &&
                    ...
                    Number(authUser.id) !== parseInt(userId) && (
                      <button
                        ...
                        className="flex items-center gap-1.5 px-4 py-2 bg-violet-500 text-white rounded-xl text-xs sm:text-sm font-semibold max-[400px]:w-full max-[400px]:justify-center hover:bg-violet-600 active:bg-violet-700 transition-colors"
                      >
